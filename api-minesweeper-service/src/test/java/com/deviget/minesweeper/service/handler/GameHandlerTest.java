...
public class GameHandlerTest {
    ...
    @Test
    @DisplayName("Flag cell")
    public void handleFlagAction() throws IOException {

        final String TYPE = "ACTION_NOT_ALLOWED";
        final String DETAIL = "Only closed cells can be flagged";
        ...
        GameException gameException = Assertions.assertThrows(GameException.class, () -> {
            ...
            gameHandler.handleAction(game, new GameMove(1, 1, GameAction.FLAG));
        });
    ...
    public void handleMarkAction() throws IOException {

        final String TYPE = "ACTION_NOT_ALLOWED";
        final String DETAIL = "Only closed cells can be marked";
        final int STATUS = 406;
    ...
    public void handleFlipActionThrowException() throws IOException {
        ...
        final String TYPE = "ACTION_NOT_ALLOWED";
        final String DETAIL = "Only closed cells can be flipped";
        final int STATUS = 406;
